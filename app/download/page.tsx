...
const steps = [
  {
    ...
    desc: 'Download and run the installer. AIM Data runs as a Docker container on your machine - nothing is sent anywhere.',
    icon: (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-12 sm:pt-32 sm:pb-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto">
              AIM Data runs on your infrastructure, processes your data locally with AI, and
