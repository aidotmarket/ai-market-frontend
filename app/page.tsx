...
const valueProps = [
  ...
  {
    title: 'Non-Custodial',
    description: 'You host the data. We facilitate the transaction. 5% commission, no lock-in.',
    iconPath:
...
const LANDING_JSONLD = [
  {
    ...
    "name": "ai.market",
    "url": "https://ai.market",
    "description": "B2B Data Marketplace — Making data discoverable by AI systems",
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-gray-600">
            Join the marketplace where AI agents discover and purchase data.
