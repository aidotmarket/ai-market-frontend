    ...
    <div className="mx-auto max-w-3xl px-6 py-16 lg:py-24">
      ...
      <section className={sectionClass}>
        ...
        <ul className={listClass}>
          ...
          <li>The buyer pays the transaction costs. That covers Stripe, stablecoin, and escrow fees. Our commission is 5% of the deal and it comes out of the seller&apos;s proceeds, not on top of the buyer&apos;s price.</li>
          <li>Card money is held until the refund window closes, which is 90 days. If a buyer pays by card, the seller gets paid after that period passes, and the payment processor holds the money in the meantime, not us.</li>
      ...
      <section id="fees" className={`${sectionClass} scroll-mt-24`}>
        ...
        <p className={paragraphClass}>5.1 Commission. We charge a 5% Commission on the value of a successful transaction. We charge no listing fees. The Commission is deducted from the Seller&apos;s proceeds and is not added to the Buyer&apos;s price. The Seller therefore receives 95% of the listing price.</p>
        ...
        <p className={paragraphClass}>5.3 Card funds held by the Payment Provider until the Refund Period passes (90 days, defined in 2.7). Where a Buyer pays by credit card, the Payment Provider holds or reserves the funds and does not release them to the Seller until the Refund Period has passed. ai.market does not hold these funds; it only instructs the Payment Provider to release them once the Refund Period closes. Release is also subject to chargebacks, reversals, provider rules, sanctions review, and legal holds. This protects against reversals and chargebacks while keeping ai.market non-custodial.</p>
