...
it('shows the published free sample count and review sample status',async()=>{
 ...
 expect(await screen.findByText('2 sample files published free · Sample status: selected')).toBeTruthy();
});
